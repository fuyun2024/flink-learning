package com.sf.bdp.kafkaSource;

import com.sf.bdp.kafkaSource.provider.CachedSchemaCoderProvider;
...
public class Kafka2Print {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(Kafka2Print.class);

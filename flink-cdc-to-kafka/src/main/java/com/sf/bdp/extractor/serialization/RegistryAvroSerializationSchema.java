...
public class RegistryAvroSerializationSchema<T> extends AvroSerializationSchema<T> {
     ...
     */
    private final WriteSchemaCoder.SchemaCoderProvider schemaCoderProvider;
    ...
    public RegistryAvroSerializationSchema(
            Class<T> recordClazz,
            Schema schema,
            WriteSchemaCoder.SchemaCoderProvider schemaCoderProvider) {
    ...
    public byte[] serialize(T object) {
        ...
        if (object == null) {
            ...
            try {
                ...
                schemaCoder.writeSchema(getSubject(), getSchema(), outputStream);
                getDatumWriter().setSchema(getSchema());
